...
const ActionDescriptionEnum = {
  ...
  DELETE_LIST: `Delete this list? All its tasks and team data will be removed, but you can restore it within 10 days. Retrieve deleted lists from Deleted section.`,
};

const maxLabels = 3;

export { maxLabels, ActionsOnEntitiesEnum, ActionDescriptionEnum };